...
public partial class Jobseeker_SearchByCountry : System.Web.UI.Page
{
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        ...
        string str1;
        str1 = "Select Company_name,job_title,Qual_req,Exp_req from Company,jobdetail,Employer where Company.Employer_Id = jobdetail.Employer_id and  Country_id = " + drpcountry.SelectedItem.Value + " ";
